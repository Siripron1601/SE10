                    ...
                    <div class="card-body" >
                      <div class="row mb-4">
                        <div class="col-xl-2 col-12 text-right">
                          <span>ผู้อนุมัติการยืม</span>
                        </div>
                        <div class="col-xl-9 col-12">
                            <select class="form-control" id="cars">
                              
                              <option value="volvo">อ.นุชนาฎ สัตยากวี</option>
                              <option value="saab">อ.นุชนาฎ สัตยากวี</option>
                            </select>
                        </div>
                      </div>
                      <div class="row mb-4">
                        ...
                        <div class="col-xl-9 col-12">
                        <textarea style="resize:none;" class="form-control rounded-0" id="exampleFormControlTextarea2" rows="3">เอาไปใช้การทดลองเขียนเว็บของ อ.นุชนาฎ </textarea>
                        </div>
                    </div>
                  </div>
                </div>
                    ...
                    <table class="table table-bordered"  width="100%" cellspacing="0">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><input class="form-control form-control-user" type="number" min="0" value="1" ></td>
                        </tr>
                        <tr>
                          ...
                          <td><input class="form-control form-control-user" type="number" min="0" value="2" ></td>
                        </tr>
                      </tbody>
                    </table>
